...
- Sitemap (52 URLs) is auto-generated by `tools/generate-sitemap.py` and drift-checked in CI on every deploy (`--check`) — new pages are picked up automatically, no manual sync needed (see `docs/SITEMAP-FIX-HANDOVER-2026-06-25.md`)
