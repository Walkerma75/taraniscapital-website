...
- **CloudTrail:** **not configured** (confirmed by Mark 2026-04-20). No audit trail exists for changes in this account. First trail is free, subsequent multi-region trails ~£2/month. Follow-up candidate.
...
| No CloudTrail / audit trail configured in the account | Medium | Follow-up — enable a single (free) trail; even if never read, it's cheap insurance |
